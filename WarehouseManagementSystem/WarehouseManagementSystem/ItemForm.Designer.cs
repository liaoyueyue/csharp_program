namespace WarehouseManagementSystem
{
	partial class ItemForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.operationGroupBox.Location = new System.Drawing.Point(0, 36);
			...
			this.operationGroupBox.TabIndex = 15;
			...
			this.ItemId1.HeaderText = "物品编号";
			this.ItemId1.MinimumWidth = 6;
			this.ItemId1.Name = "ItemId1";
			this.ItemId1.Width = 125;
			// 
			// Column2
			// 
			...
			this.Column3.DataPropertyName = "ItemDescription";
			this.Column3.HeaderText = "物品详情";
			...
			// Column1
			// 
			this.Column1.DataPropertyName = "StockQuantity";
			this.Column1.HeaderText = "库存";
			...
			// Column5
			// 
			this.Column5.DataPropertyName = "WarehouseId";
			this.Column5.HeaderText = "仓库编号";
